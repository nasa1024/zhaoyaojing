...
export const inspectExifXmp: (a: number, b: number) => [number, number, number];
export const inspectMp4Metadata: (a: number, b: number) => [number, number, number];
export const inspectPngMetadata: (a: number, b: number) => [number, number, number];
export const supportedImageCapabilities: () => [number, number, number];
export const verifyC2pa: (a: number, b: number, c: number, d: number) => [number, number, number];
