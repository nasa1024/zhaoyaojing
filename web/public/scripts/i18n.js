...
const translations = {
  ...
  'zh-CN': {
    ...
    'page.description': '在浏览器本地检测图片里的 AI 来源线索。支持 EXIF、XMP、C2PA、PNG 文本块，可识别 Gemini、Imagen、DALL-E、Midjourney、Stable Diffusion 等平台痕迹，不上传图片。',
    'eyebrow':               'AI 图片来源检测',
    'hero.h1':               'AI 图片来源信号检测',
    'hero.lead':             '图片只在你的浏览器里<strong>本地分析，不上传服务器</strong>。重点读取元数据、平台痕迹和文件名线索。',
    ...
    'notice':                '<strong>重要提示：</strong>这不是万能 AI 鉴定器。它只读取当前文件里还保留的 EXIF / XMP / C2PA / PNG 文本块 / 文件名等线索。经过社交平台压缩、截图或重新导出的图片，很多信号会消失。',
    'upload.title':          '上传图片',
  ...
  'zh-TW': {
    ...
    'page.description': '在瀏覽器本地檢查圖片裡的 AI 來源線索。支援 EXIF、XMP、C2PA、PNG 文字區塊，可識別 Gemini、Imagen、DALL-E、Midjourney、Stable Diffusion 等平台痕跡，不上傳圖片。',
    'eyebrow':               'AI 圖片來源偵測',
    'hero.h1':               'AI 圖片溯源偵測',
  ...
  'en': {
    ...
    'page.description': 'Check AI-origin clues in image files locally in your browser. Reads EXIF, XMP, C2PA and PNG text chunks, with support for Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion and more. No uploads.',
    ...
    'notice':                '<strong>Important:</strong> This is not a magic AI detector. It only uses EXIF / XMP / C2PA / PNG text chunks / filename signals as supplementary indicators. If the image was compressed by social platforms, screenshotted, re-exported, or had metadata stripped, most signals will disappear.',
  ...
  'ja': {
    ...
    'page.description': '画像ファイル内のAI由来の手がかりをブラウザ上でローカル確認。EXIF・XMP・C2PA・PNGテキストチャンクを読み取り、Gemini・Imagen・DALL-E・Midjourney・Stable Diffusionなどに対応。アップロード不要。',
    'eyebrow':               'AI画像の出所検出',
  ...
  'ko': {
    ...
    'page.description': '브라우저에서 이미지 파일의 AI 출처 단서를 로컬로 확인합니다. EXIF, XMP, C2PA, PNG 텍스트 청크를 읽고 Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion 등을 지원합니다. 업로드 없음.',
  ...
  'de': {
    ...
    'page.description': 'Prüft Hinweise auf KI-Herkunft direkt im Browser. Liest EXIF, XMP, C2PA und PNG-Text-Chunks und unterstützt Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion und mehr. Keine Uploads.',
  ...
  'fr': {
    ...
    'page.description': "Vérifiez localement les indices d'origine IA dans une image. Lit EXIF, XMP, C2PA et les blocs texte PNG, avec prise en charge de Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion et plus. Aucun upload.",
  ...
  'es': {
    ...
    'page.description': 'Revisa indicios de origen IA directamente en el navegador. Lee EXIF, XMP, C2PA y bloques de texto PNG, con soporte para Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion y más. Sin subidas.',
  ...
  'pt-BR': {
    ...
    'page.description': 'Verifique indícios de origem por IA diretamente no navegador. Lê EXIF, XMP, C2PA e blocos de texto PNG, com suporte a Gemini, Imagen, DALL-E, Midjourney, Stable Diffusion e mais. Sem uploads.',
