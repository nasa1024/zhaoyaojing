...
const translations = {
  ...
  'ja': {
    ...
    'page.description': 'AI画像・動画の無料判定ツール。画像/動画ファイル内の AI 由来の手がかりをブラウザ内で検出・判別。EXIF、XMP、C2PA、PNG テキスト、MP4/MOV メタデータ、動画フレーム認識を読み取ります。',
    'eyebrow':               'AI画像/動画の出所検出',
    'hero.h1':               'AI画像・動画の判定ツール：残された痕跡を見る',
    'hero.lead':             'オリジナルの画像や動画をドロップして AI 生成かどうかを判定。AICheck365 は C2PA、EXIF、XMP、PNG テキスト、生成パラメータ、動画コンテナの出所手がかりを検査します。',
    'metric.uploads.value':  '0',
