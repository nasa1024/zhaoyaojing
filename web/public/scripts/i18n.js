...
const translations = {
  ...
  'zh-CN': {
    ...
    'hero.h1':               'AI 图片/视频来源信号检测',
    'hero.lead':             '图片和视频只在你的浏览器里<strong>本地分析，不上传服务器</strong>。重点读取元数据、平台痕迹、文件名线索和视频帧水印。',
  ...
  'en': {
    ...
    'hero.h1':               'AI Image/Video Origin Detector',
    'hero.lead':             'Images and videos are analyzed <strong>locally in your browser — nothing is uploaded</strong>. Detects metadata, platform traces, filename signals, and video-frame watermarks.',
    'metric.uploads.value':  '0',
