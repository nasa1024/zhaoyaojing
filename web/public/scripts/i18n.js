...
const translations = {
  ...
  'zh-CN': {
    ...
    'hero.h1':               'AI 图片/视频检测：别问它像不像，看它留下了什么',
  ...
  'zh-TW': {
    ...
    'page.title':       'AICheck365 · AI 圖片/影片檢測辨識 | 免費判斷 AI 生成內容',
    'page.description': '在瀏覽器本機辨識圖片/影片裡的 AI 來源線索，快速判斷內容是否由 AI 生成。支援 EXIF、XMP、C2PA、PNG 文字區塊、MP4/MOV metadata 與影片幀浮水印線索，不上傳檔案。',
    'eyebrow':               'AI 圖片/影片來源偵測',
    'hero.h1':               'AI 圖片/影片辨識：不要問它像不像，看它留下了什麼',
    'hero.lead':             '拖入原始圖片或影片，立即判斷是否為 AI 生成。AICheck365 會檢查 C2PA、EXIF、XMP、PNG 文字、生成參數和影片容器中的來源線索。',
    'metric.uploads.value':  '0',
  ...
  'en': {
    ...
    'page.title':       'Free AI Image & Video Detector — Runs in Your Browser | AICheck365',
    'page.description': 'Free AI image and video detector that runs in your browser. It reads C2PA Content Credentials, EXIF/XMP, PNG text chunks and MP4/MOV metadata — no uploads, no signup.',
    'eyebrow':               'AI Image/Video Origin Detection',
    'hero.h1':               'AI Image & Video Detector: see what the file left behind',
  ...
  'ja': {
    ...
    'page.title':       'AICheck365 · AI画像/動画 判定・検出ツール | 無料でAI生成メディアを判別',
    'page.description': 'AI画像・動画の無料判定・検出ツール。EXIF、XMP、C2PA、PNG テキスト、MP4/MOV メタデータ、動画フレームの透かしなど、ファイルに残る手がかりをブラウザ内で読み取り、AI 生成かどうかの判別を支援します。ファイルはアップロードされません。',
    'eyebrow':               'AI画像/動画の出所検出',
    'hero.h1':               'AI画像・動画の判定ツール：残された痕跡を見る',
    'hero.lead':             'オリジナルの画像や動画をドロップするだけ。AICheck365 が C2PA、EXIF、XMP、PNG テキスト、生成パラメータ、動画コンテナを調べ、AI 生成の痕跡が残っていないかを確認します。',
    'metric.uploads.value':  '0',
    ...
    'trust.original':        'オリジナルファイルに最適',
    'trust.original.desc':   '加工や転送を経ていない元ファイルほどシグナルが残っています',
    'trust.explain':         '説明可能な結果',
    'trust.explain.desc':    '一致したシグナル・信頼度・フィールドの詳細を表示します',
    'notice':                '<strong>ご注意：</strong>これは「何でも見抜ける」万能の AI 判定ツールではありません。ファイルに現在も残っている EXIF / XMP / C2PA / PNG テキストチャンク / MP4・MOV メタデータ / ファイル名などの手がかりを読み取り、判断を補助します。SNS での再圧縮やスクリーンショット、再書き出しを経たファイルでは、多くのシグナルがすでに失われています。動画のフレーム分析はブラウザ内で実行されるため、時間がかかる場合があります。',
    ...
    'hero.h1':               'AI画像・動画の判定ツール：残された痕跡を見る',
    'hero.lead':             'オリジナルの画像や動画をドロップするだけ。AICheck365 が C2PA、EXIF、XMP、PNG テキスト、生成パラメータ、動画コンテナを調べ、AI 生成の痕跡が残っていないかを確認します。',
    'hero.privacy':          'ファイルはブラウザ内で処理され、端末の外に送信されることはありません。',
    'hero.cta.primary':      'オリジナルファイルをドロップ',
    'hero.cta.secondary':    'まずサンプルで試してみる',
    // result page keys
  ...
  'ko': {
    ...
    'page.title':       'AICheck365 · AI 이미지/비디오 판독기 | 무료 AI 생성 이미지 판별',
    'page.description': 'AI 생성 이미지 판별 도구. 브라우저에서 이미지/비디오 파일의 AI 출처 단서를 로컬로 판독합니다. EXIF, XMP, C2PA, PNG 텍스트, MP4/MOV 메타데이터, 비디오 프레임 워터마크를 읽습니다.',
    'eyebrow':               'AI 이미지/동영상 출처 감지',
    'hero.h1':               'AI 이미지·영상 판독기: 파일에 남은 흔적을 확인',
    'hero.lead':             '원본 이미지나 동영상을 드롭해 AI 생성 여부를 판별하세요. AICheck365는 C2PA, EXIF, XMP, PNG 텍스트, 생성 파라미터, 동영상 컨테이너의 출처 단서를 검사합니다.',
    'metric.uploads.value':  '0',
  ...
  'de': {
    ...
    'page.title':       'KI-Bilder & Videos kostenlos prüfen — im Browser | AICheck365',
    'page.description': 'Kostenlose KI-Bild- und Videoerkennung direkt im Browser: liest C2PA Content Credentials, EXIF/XMP, PNG-Text und MP4/MOV-Metadaten — ohne Upload, ohne Anmeldung.',
    ...
    'hero.h1':               'KI-Bild- und Video-Detektor: sieh, was die Datei hinterlassen hat',
  ...
  'fr': {
    ...
    'page.title':       "Détecteur d'images et vidéos IA gratuit — navigateur | AICheck365",
    'page.description': "Détecteur d'images et vidéos IA gratuit qui tourne dans votre navigateur : lit le C2PA, les métadonnées EXIF/XMP, les textes PNG et MP4/MOV. Sans envoi de fichier.",
    ...
    'hero.h1':               "Détecteur d'images et vidéos IA : voyez ce que le fichier a laissé",
  ...
  'es': {
    ...
    'page.title':       'AICheck365 · Detector de Imágenes y Videos IA Gratis',
    'page.description': 'Detector de imágenes y videos IA gratis: comprueba si una imagen es IA revisando EXIF, XMP, C2PA, texto PNG y metadatos MP4/MOV en tu navegador. Sin subidas.',
    'eyebrow':               'Detección de origen IA de imágenes/videos',
    'hero.h1':               'Detector de imágenes y videos IA: mira lo que dejó el archivo',
    'hero.lead':             'Comprueba gratis si una imagen o video es IA. Suelta el archivo original: AICheck365 inspecciona C2PA, EXIF, XMP, texto PNG, parámetros de generación y contenedores de video.',
    'metric.uploads.value':  '0',
  ...
  'pt-BR': {
    ...
    'page.title':       'Detector de imagens e vídeos de IA grátis, no navegador | AICheck365',
    'page.description': 'Detector de imagens e vídeos de IA grátis que roda no seu navegador: lê C2PA, metadados EXIF/XMP, textos PNG e MP4/MOV. Sem upload e sem cadastro.',
    ...
    'hero.h1':               'Detector de imagens e vídeos de IA: veja o que o arquivo deixou',
...
// ─── Result-page related-reading row + state-D conflict labels (merged above) ──
const RESULT_LABELS = {
  'zh-CN': { 'result.related': '相关阅读', 'result.related.platform': '查看该平台检测指南', 'result.related.platforms': '全部平台指南', 'result.related.guide': '相关检测指南', 'result.related.methodology': '方法论与限制', 'result.conflict': '失败 / 冲突详情', 'result.conflict.signature': '数字签名验证失败：来源声明存在，但无法被验证。', 'result.conflict.fields': '字段之间存在冲突：例如相机 EXIF 与 AI 工具标记同时出现。' },
  'zh-TW': { 'result.related': '相關閱讀', 'result.related.platform': '查看該平台檢測指南', 'result.related.platforms': '全部平台指南', 'result.related.guide': '相關檢測指南', 'result.related.methodology': '方法論與限制', 'result.conflict': '失敗 / 衝突詳情', 'result.conflict.signature': '數位簽名驗證失敗：來源聲明存在，但無法被驗證。', 'result.conflict.fields': '欄位之間存在衝突：例如相機 EXIF 與 AI 工具標記同時出現。' },
  'en': { 'result.related': 'Related reading', 'result.related.platform': "View this platform’s guide", 'result.related.platforms': 'All platform guides', 'result.related.guide': 'Related detection guide', 'result.related.methodology': 'Methodology & limits', 'result.conflict': 'Failure / conflict details', 'result.conflict.signature': 'Signature validation failed: a provenance claim exists but cannot be verified.', 'result.conflict.fields': 'Fields conflict: e.g. camera EXIF and an AI-tool marker appear together.' },
  'ja': { 'result.related': '関連情報', 'result.related.platform': 'このプラットフォームの検出ガイド', 'result.related.platforms': 'すべてのプラットフォームガイド', 'result.related.guide': '関連する検出ガイド', 'result.related.methodology': '方法論と制限', 'result.conflict': '失敗 / 競合の詳細', 'result.conflict.signature': '署名の検証に失敗：出所の主張は存在しますが、検証できません。', 'result.conflict.fields': 'フィールドの競合：例えばカメラ EXIF と AI ツールのマーカーが同時に存在します。' },
  'ko': { 'result.related': '관련 읽을거리', 'result.related.platform': '이 플랫폼 감지 가이드 보기', 'result.related.platforms': '전체 플랫폼 가이드', 'result.related.guide': '관련 감지 가이드', 'result.related.methodology': '방법론과 한계', 'result.conflict': '실패 / 충돌 상세', 'result.conflict.signature': '서명 검증 실패: 출처 주장은 있으나 검증할 수 없습니다.', 'result.conflict.fields': '필드 충돌: 예를 들어 카메라 EXIF와 AI 도구 표시가 함께 나타납니다.' },
  'de': { 'result.related': 'Weiterführende Informationen', 'result.related.platform': 'Leitfaden zu dieser Plattform', 'result.related.platforms': 'Alle Plattform-Guides', 'result.related.guide': 'Passender Erkennungs-Guide', 'result.related.methodology': 'Methodik & Grenzen', 'result.conflict': 'Fehler- / Konfliktdetails', 'result.conflict.signature': 'Signaturprüfung fehlgeschlagen: Eine Herkunftsangabe existiert, kann aber nicht verifiziert werden.', 'result.conflict.fields': 'Feldkonflikt: z. B. Kamera-EXIF und ein AI-Tool-Marker treten gemeinsam auf.' },
  'fr': { 'result.related': 'À lire aussi', 'result.related.platform': 'Voir le guide de cette plateforme', 'result.related.platforms': 'Tous les guides plateformes', 'result.related.guide': 'Guide de détection associé', 'result.related.methodology': 'Méthodologie et limites', 'result.conflict': "Détails de l’échec / du conflit", 'result.conflict.signature': "Échec de la validation de signature : une revendication d’origine existe mais ne peut être vérifiée.", 'result.conflict.fields': "Conflit de champs : par ex. EXIF d’appareil photo et marqueur d’outil IA présents ensemble." },
  'es': { 'result.related': 'Lecturas relacionadas', 'result.related.platform': 'Ver la guía de esta plataforma', 'result.related.platforms': 'Todas las guías de plataformas', 'result.related.guide': 'Guía de detección relacionada', 'result.related.methodology': 'Metodología y límites', 'result.conflict': 'Detalles del fallo / conflicto', 'result.conflict.signature': 'Falló la validación de la firma: existe una declaración de origen pero no puede verificarse.', 'result.conflict.fields': 'Conflicto de campos: p. ej. EXIF de cámara y un marcador de herramienta IA aparecen juntos.' },
  'pt-BR': { 'result.related': 'Leituras relacionadas', 'result.related.platform': 'Ver o guia desta plataforma', 'result.related.platforms': 'Todos os guias de plataformas', 'result.related.guide': 'Guia de detecção relacionado', 'result.related.methodology': 'Metodologia e limites', 'result.conflict': 'Detalhes da falha / conflito', 'result.conflict.signature': 'Falha na validação da assinatura: existe uma declaração de origem, mas não pode ser verificada.', 'result.conflict.fields': 'Conflito de campos: ex. EXIF de câmera e um marcador de ferramenta de IA aparecem juntos.' },
};
for (const [lang, labels] of Object.entries(RESULT_LABELS)) {
  if (translations[lang]) Object.assign(translations[lang], labels);
}
